...
function Home(props) {
  ...
  var inscription = async (e) => {
    e.preventDefault()
   
    var data = await fetch('/users/sign-up', {
      method: 'POST',
    ...
    <div style={{backgroundColor:'#f1e8da', height:'100vh'}}>
      ...
      <div className='signprocess'>
        ...
        <Form className='inscription' 
          ...
          // onSubmit = {(e) =>{  console.log('clic'); inscription(e)}}
          ...
          <Form.Control type='email' required onChange={(e) => setEmail1(e.target.value)} value={email1}  placeholder='E-mail'className='input01'/>
          ...
          <Button style={{backgroundColor:"#333367", width:'50%', marginTop: '5%'}} type="submit" className='button01' >Inscription</Button>
          <br className='input01'/>
          {errorSignUpList}
        </Form>
